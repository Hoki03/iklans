    ...
    <script>
        ...
        function format() {
            ...
            rupiah1.addEventListener("keyup", function(e) {
                ...
                rupiah1.value = convertRupiah1(this.value, "Rp. ");
                nominal.value = convertRupiah2(this.value);

            });


            function convertRupiah1(angka, prefix) {
            ...
            function convertRupiah2(angka, prefix) {
                var number_string = angka.replace(/[^,\d]/g, "").toString(),
                    split = number_string.split(","),
                    sisa = split[0].length % 3,
                    rupiah = split[0].substr(0, sisa),
